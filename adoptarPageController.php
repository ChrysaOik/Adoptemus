<?php
    ...
    // B) El listado de animales
    $animalsModule = new AnimalsModule();
    
    // Voy a crear mediante la VISTA un objeto especifico para visualizar animales. Le voy a proporcionar la info que he solicitado al modelo
    $vista = new AnimalsView($navItemsModule->getNavItemsList(), $animalsModule->getNormalAnimalsOrderedBy('id'));
