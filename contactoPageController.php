<?php
    ...
    if (isset($_POST['nombre']) and isset($_POST['email']) and isset($_POST['mensaje'])){
        ...
        $message = new Contacto($nombre, $email, $mensaje);
        $contacto = new ContactoModule();
        $contacto->sendMessageToBD($message);
    }
    ...
    $vista = new ContactView($navItemsModule->getNavItemsList());
